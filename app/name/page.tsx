            ...
            {!result && !isAnalyzing && (
              <>
                ...
                <section className="mb-12">
                  <Card className="max-w-6xl mx-auto shadow-lg border border-slate-200 dark:border-slate-700 bg-white/90 dark:bg-slate-900/90">
                        ...
                        {Object.entries(result.numerology).filter(([key]) => !key.includes('_fortune')).map(([key, value]) => {
                          ...
                          return (
                            <div key={key} className="text-center relative">
                              <div className={`bg-white dark:bg-slate-900 p-4 rounded-lg border transition-all duration-200 ${isMainGe
